...
public final class ThreeDeadWheelLocalizer implements Localizer {
    ...
    public ThreeDeadWheelLocalizer(HardwareMap hardwareMap, double inPerTick) {
        ...
        par0 = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "leftOdom")));
        par1 = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "rightOdom")));
        perp = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "centerOdom")));
