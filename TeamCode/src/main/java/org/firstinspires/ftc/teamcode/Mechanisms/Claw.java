...
public class Claw {
    ...
    public Claw(HardwareMap hardwareMap) {
        ...
        liftMotorTop = hardwareMap.get(DcMotor.class, "Claw Slide Bottom");
        liftMotorBottom = hardwareMap.get(DcMotor.class, "Claw Slide Top");
    ...
    }public void open(){pinchServo.setPosition(0);}
